...
public static class DependencyInjection
{
        ...
        PersistenceProvider provider = PersistenceProvider.Postgres)
    {
        ...
        services.AddScoped<Sync.ISyncEventApplier, Sync.SaleVoidedApplier>();
        services.AddScoped<Sync.ISyncEventApplier, Sync.SaleReceiptReprintedApplier>();
        services.AddScoped<Sync.ISyncEventApplier, Sync.SalesReturnCreatedApplier>();
        services.AddScoped<Sync.ISyncEventApplier, Sync.RefundIssuedApplier>();
        ...
        services.TryAddScoped<IReturnDispositionRepository, ReturnDispositionRepository>();
        ...
        services.TryAddScoped<Application.Reports.ISalesAnalysisRepository, SalesAnalysisRepository>();
        ...
        services.TryAddScoped<Application.Reports.IAuditReportRepository, AuditReportRepository>();
        services.TryAddScoped<Application.Reports.IDashboardRepository, DashboardRepository>();

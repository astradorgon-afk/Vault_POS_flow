...
namespace Pos.Infrastructure.Persistence.Migrations.Postgres
{
    ...
    [Migration("20260917175141_SyncChangeFeed")]
    partial class SyncChangeFeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pos.Domain.Inventory.InventoryCount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("ux_inventory_count_number");

                    b.HasIndex("LocationId", "CreatedAtUtc")
                        .HasDatabaseName("ix_inventory_count_location_time");

                    b.ToTable("inventory_count", "inventory");
                });

            modelBuilder.Entity("Pos.Domain.Inventory.InventoryCountLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<bool>("IsRepeatVariance")
                        .HasColumnType("boolean")
                        .HasColumnName("is_repeat_variance");
                    ...
                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_inventory_count_line_product");

                    b.HasIndex("InventoryCountId", "LineNo")
                        .IsUnique()
                        .HasDatabaseName("ux_inventory_count_line_no");
            ...
            modelBuilder.Entity("Pos.Domain.Inventory.NegativeStockAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("LocationId", "AttemptedAtUtc")
                        .HasDatabaseName("ix_negative_stock_attempt_location_time");

                    b.HasIndex("ProductId", "AttemptedAtUtc")
                        .HasDatabaseName("ix_negative_stock_attempt_product_time");

                    b.ToTable("negative_stock_attempt", "inventory");
                });

            modelBuilder.Entity("Pos.Domain.Inventory.StockAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("LocationId", "CreatedAtUtc")
                        .HasDatabaseName("ix_stock_adjustment_location_time");

                    b.ToTable("stock_adjustment", "inventory");
                });

            modelBuilder.Entity("Pos.Domain.Inventory.StockAdjustmentLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("StockAdjustmentId", "LineNo")
                        .IsUnique()
                        .HasDatabaseName("ux_stock_adjustment_line_no");

                    b.ToTable("stock_adjustment_line", "inventory");
                });
            ...
            modelBuilder.Entity("Pos.Domain.Notifications.Notification", b =>
                {
                    ...
                    b.HasIndex("DeduplicationKey")
                        .IsUnique()
                        .HasDatabaseName("ux_notification_deduplication_key");

                    b.HasIndex("LocationId", "CreatedAtUtc")
                        .HasDatabaseName("ix_notification_location_time");

                    b.ToTable("notification", "core");
                });

            modelBuilder.Entity("Pos.Domain.Notifications.NotificationReceipt", b =>
                {
                    ...
                    b.HasIndex("UserId", "ReadAtUtc")
                        .HasDatabaseName("ix_notification_receipt_user_read");

                    b.ToTable("notification_receipt", "core");
                });
            ...
            modelBuilder.Entity("Pos.Domain.Receipts.Receipt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("LocationId", "IssuedAtUtc")
                        .HasDatabaseName("ix_receipt_location_time");

                    b.ToTable("receipt", "core");
                });
            ...
            modelBuilder.Entity("Pos.Domain.Sales.Refund", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Pos.Domain.Sales.Sale", b =>
                {
                    ...
                    b.Property<decimal>("TaxableBaseTotal")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)")
                        .HasColumnName("taxable_base_total");

                    b.Property<decimal>("VatExemptTotal")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)")
                    ...
                    b.Property<decimal>("ZeroRatedTotal")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)")
            ...
            modelBuilder.Entity("Pos.Domain.Sales.SaleReceiptPrint", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Pos.Domain.Sales.SalesReturnItem", b =>
                {
                    ...
                    b.HasIndex("ProductId", "SalesReturnId")
                    ...
                    b.ToTable("sales_return_item", "sales");
                });
            ...
            modelBuilder.Entity("Pos.Infrastructure.Identity.RoleDefaultGrantApplied", b =>
                {
                    ...
                    b.ToTable("role_default_grant_applied", "core");
                });
            ...
            modelBuilder.Entity("Pos.Infrastructure.Sync.ChangeFeedEntry", b =>
                {
            ...
            modelBuilder.Entity("Pos.Infrastructure.Sync.ChangeFeedSequence", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                    ...
                    b.ToTable("feed_sequence", "sync");
                });

            modelBuilder.Entity("Pos.Infrastructure.Sync.ProcessedEvent", b =>
                {
                    b.Property<Guid>("EventId")
                        .HasColumnType("uuid")
                        .HasColumnName("event_id");
            ...
            modelBuilder.Entity("Pos.Infrastructure.Sync.SyncCheckpoint", b =>
                {
                    b.Property<Guid>("DeviceId")
                        .HasColumnType("uuid")
                        .HasColumnName("device_id");

                    b.Property<long>("LastAcceptedDeviceSequence")
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("sync_checkpoint", "sync");
                });
            ...
            modelBuilder.Entity("Pos.Domain.Inventory.InventoryCountLine", b =>
                {
                    b.HasOne("Pos.Domain.Inventory.InventoryCount", null)
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Pos.Domain.Inventory.StockAdjustmentLine", b =>
                {
                    b.HasOne("Pos.Domain.Inventory.StockAdjustment", null)
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Pos.Domain.Notifications.NotificationReceipt", b =>
                {
                    b.HasOne("Pos.Domain.Notifications.Notification", null)
                        .WithMany()

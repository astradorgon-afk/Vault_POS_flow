...
namespace Pos.Infrastructure.Persistence.Migrations.Postgres
{
    ...
    [Migration("20260912203959_AddTransfers")]
            ...
            modelBuilder.Entity("Pos.Domain.Catalog.ProductLocationSetting", b =>
                {
                    ...
                    b.ToTable("product_location_setting", "catalog", t =>
                        {
                            t.HasCheckConstraint("ck_product_location_thresholds", "minimum_stock <= reorder_point AND reorder_point <= target_stock AND target_stock <= maximum_stock");
                        });
                });
